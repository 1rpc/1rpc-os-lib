...
include <1rpc-os-lib/2_base/math.scad>


//generates a motor mount for the specified nema standard #.
module stepper_motor_mount(nema_standard,slide_distance=0, mochup=true, tolerance=0, aBoltHoleSize = 3.5 ) {
	//dimensions from:
...
// translate ( [100,0,0] ) stepper_motor_mount( 23 );
